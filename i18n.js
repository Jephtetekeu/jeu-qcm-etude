...
const TRANSLATIONS = {
  fr: {
    ...
    'quiz.score': 'Score :',
    'quiz.correct': '<i class="fa-solid fa-circle-check"></i> Bonne réponse !',
    'quiz.timeout': '<i class="fa-solid fa-clock"></i> Temps écoulé !',
    'quiz.wrong': '<i class="fa-solid fa-circle-xmark"></i> Mauvaise réponse.',
    ...
    'duel.correct': '<i class="fa-solid fa-circle-check"></i> Bonne réponse',
    'duel.wrong': '<i class="fa-solid fa-circle-xmark"></i> Mauvaise réponse',
    'duel.result': 'Résultat du duel',
    'duel.winner': 'Vainqueur <i class="fa-solid fa-trophy"></i>',
    'duel.tie': '<i class="fa-solid fa-handshake"></i> Égalité parfaite !',
  ...
  en: {
    ...
    'quiz.score': 'Score:',
    'quiz.correct': '<i class="fa-solid fa-circle-check"></i> Correct!',
    'quiz.timeout': '<i class="fa-solid fa-clock"></i> Time\'s up!',
    'quiz.wrong': '<i class="fa-solid fa-circle-xmark"></i> Wrong answer.',
    ...
    'duel.correct': '<i class="fa-solid fa-circle-check"></i> Correct',
    'duel.wrong': '<i class="fa-solid fa-circle-xmark"></i> Wrong answer',
    'duel.result': 'Duel result',
    'duel.winner': 'Winner <i class="fa-solid fa-trophy"></i>',
    'duel.tie': '<i class="fa-solid fa-handshake"></i> Perfect tie!',
    'duel.noanswer': 'None',
